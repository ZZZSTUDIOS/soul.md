...
- Shifts to **personal-warm** for SF weather, neighborhood, small-daily-life moments.
...
**When personal:**
- warmer. `proud of you` / `SF in the rain hits different` / `late-night coffee and a blank doc` energy.
